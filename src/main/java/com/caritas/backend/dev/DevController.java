...
public class DevController {
    ...
    public DevController(UserRepository userRepository, ServiceRepository serviceRepository,
            HostelRepository hostelRepository,
            HostelServiceRepository hostelServiceRepository, ReservationRepository reservationRepository,
